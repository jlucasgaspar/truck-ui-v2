...
type FormFields = Driver.FormFields.Create;

export const CreateDriverForm: React.FC = () => {
	const [isLoading, setLoading] = useState<boolean>(false);
	const { register, handleSubmit, control, setValue, formState: { errors } } = useForm<FormFields>({ resolver });
	const styles = useStyles();

	const handleCreateDriver = useCallback(async (data: FormFields) => {
